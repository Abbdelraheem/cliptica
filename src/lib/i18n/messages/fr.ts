...
export const fr: MessageCatalog = {
  ...
  geoAnswer: {
    ...
    whatIsFact:
      'Clipzila applique un tarif fixe de 1 crédit par vidéo finale, avec un forfait Starter à 29 $/mois pour 150 vidéos et Pro Creator à 59 $/mois pour 400 vidéos.',
