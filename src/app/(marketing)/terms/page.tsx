...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service and acceptable use rules for Clipzila AI video clipping platform.',
}
      ...
      <div className="mx-auto max-w-4xl px-5 pt-32 pb-24 sm:px-6">
        ...
        <div className="mt-10 space-y-10 text-mist leading-relaxed">
          <section className="space-y-3">
            ...
            <p>
              By accessing, browsing, registering for, or using the Clipzila platform (&quot;Service&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;),
          ...
          <section className="space-y-3">
            ...
            <p>
              Clipzila is an AI-powered media processing software tool. We provide automated audio transcription, virality scoring, facial tracking reframing,
          ...
          <section className="space-y-3">
            ...
            <p>
              Clipzila reserves the right to immediately suspend or terminate any account, without liability or refund, if we determine in our sole discretion that
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              In no event shall Clipzila, its founders, or affiliates be liable for any indirect, incidental, consequential, or punitive damages, including loss of profits,
