      ...
      <div className="grid items-center gap-10 sm:gap-14 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <p className="mt-6 max-w-lg text-lg leading-relaxed text-mist">
            Paste a YouTube link. Clipzila finds the viral moments, cuts them vertical with
...
const STEPS = [
  {
    ...
    body: 'Drop any YouTube URL or upload a file. Clipzila pulls the video and builds a transcription within seconds.',
    tag: 'STEP 01',
  },
  {
    icon: Target,
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-md leading-relaxed text-mist">
              ...
              midnight — for maybe two clips. Clipzila returns six scored, captioned, vertical
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 rounded-2xl border border-[#ff5a1f]/40 bg-[#ff5a1f]/[0.06] p-6">
              <p className="mb-2 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#ffb27a]">
                <Zap className="h-3.5 w-3.5" /> With Clipzila
              </p>
