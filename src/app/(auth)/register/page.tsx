      ...
      <div className="relative z-[2] grid w-full max-w-4xl gap-10 md:grid-cols-[1fr_1.1fr] md:items-center">
        ...
        <div className="hidden md:block">
          ...
          <ul className="mt-8 space-y-3.5">
            {['5 free credits — no card required', 'Karaoke captions unlocked', 'Campaign ledger from day one'].map(
              (item) => (
        ...
        <div className="rounded-3xl border border-hair bg-gradient-to-b from-pearl/[0.05] to-pearl/[0.01] p-5 sm:p-9 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="mt-7 space-y-4">
            ...
            {error && (
              <p role="alert" aria-live="assertive" className="flex items-start gap-2 rounded-lg border border-red-400/30 bg-red-400/10 px-4 py-2.5 text-sm text-red-300">
